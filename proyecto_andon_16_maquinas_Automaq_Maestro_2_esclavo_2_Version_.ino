...
void setup()
{
  ...
  radio.setChannel(102); // Apertura del canal especifico
...
void loop() {
  ...
  */
  ...
  while (radio.available(&pipeNum)) { //Verificar si hay datos de los esclavos
    radio.read(&dataRX, 2 ); //Se lee un byte, ya que hemos configurado solo en envio de una letra
    //--------------------------------------------------------------------------------------
    if (210 < dataRX < 220) //Letra correspondiente al transmisor 1
    {
      if (dataRX == 211) //Letra correspondiente al transmisor 1 boton a
      {
        valor_ma = 1; //
        delay(100);
      } else if (dataRX == 212) //Letra correspondiente al transmisor 1 boton b
      {
        valor_ma = 2; //
        delay(100);
      } else if (dataRX == 213) //Letra correspondiente al transmisor 1 boton c
      {
        valor_ma = 3; //
        delay(100);
      } else if (dataRX == 214) //Letra correspondiente al transmisor 1 boton d
      {
        valor_ma = 4; //
        delay(100);
      } else if (dataRX == 215) //Letra correspondiente al transmisor 1 boton e
      {
        valor_ma = 5; //
        delay(100);
      }
      else if (dataRX == 216) //Letra correspondiente al transmisor 1 boton f
      {
        valor_ma = 6; //
        delay(100);
      }
      else if (dataRX == 217) //Letra correspondiente al transmisor 1 boton ok
      {
        valor_ma = 7; //
        delay(100);
      }
    ...
    //--------------------------------------------------------------------------------------
    if (220 < dataRX < 230) //Letra correspondiente al transmisor 2
    {
      if (dataRX == 221) //Letra correspondiente al transmisor 2 boton a
      {
        valor_mb = 1; //
        delay(100);
      } else if (dataRX == 222) //Letra correspondiente al transmisor 2 boton b
      {
        valor_mb = 2; //
        delay(100);
      } else if (dataRX == 223) //Letra correspondiente al transmisor 2 boton c
      {
        valor_mb = 3; //
        delay(100);
      } else if (dataRX == 224) //Letra correspondiente al transmisor 2 boton d
      {
        valor_mb = 4; //
        delay(100);
      } else if (dataRX == 225) //Letra correspondiente al transmisor 2 boton e
      {
        valor_mb = 5; //
        delay(100);
      } else if (dataRX == 226) //Letra correspondiente al transmisor 2 boton f
      {
        valor_mb = 6; //
        delay(100);
      } else if (dataRX == 227) //Letra correspondiente al transmisor 2 boton ok
      {
        valor_mb = 7; //
        delay(100);
      }
    ...
    //--------------------------------------------------------------------------------------
    if (230 < dataRX < 240) //Letra correspondiente al transmisor 3
    {
      if (dataRX == 231) //Letra correspondiente al transmisor 3 boton a
      {
        valor_mc = 1; //
        delay(100);
      } else if (dataRX == 232) //Letra correspondiente al transmisor 3 boton b
      {
        valor_mc = 2; //
        delay(100);
      } else if (dataRX == 233) //Letra correspondiente al transmisor 3 boton c
      {
        valor_mc = 3; //
        delay(100);
      } else if (dataRX == 234) //Letra correspondiente al transmisor 3 boton d
      {
        valor_mc = 4; //
        delay(100);
      } else if (dataRX == 235) //Letra correspondiente al transmisor 3 boton e
      {
        valor_mc = 5; //
        delay(100);
      } else if (dataRX == 236) //Letra correspondiente al transmisor 3 boton f
      {
        valor_mc = 6; //
        delay(100);
      } else if (dataRX == 237) //Letra correspondiente al transmisor 3 boton ok
      {
        valor_mc = 7; //
        delay(100);
      }
    ...
    //--------------------------------------------------------------------------------------
    if (240 < dataRX < 250) //Letra correspondiente al transmisor 4
    {
      if (dataRX == 241) //Letra correspondiente al transmisor 4 boton a
      {
        valor_md = 1; //
        delay(100);
      } else if (dataRX == 242) //Letra correspondiente al transmisor 4 boton b
      {
        valor_md = 2; //
        delay(100);
      } else if (dataRX == 243) //Letra correspondiente al transmisor 4 boton c
      {
        valor_md = 3; //
        delay(100);
      } else if (dataRX == 244) //Letra correspondiente al transmisor 4 boton d
      {
        valor_md = 4; //
        delay(100);
      } else if (dataRX == 245) //Letra correspondiente al transmisor 4 boton e
      { valor_md = 5; //
        delay(100);
      } else if (dataRX == 246) //Letra correspondiente al transmisor 4 boton f
      {
        valor_md = 6; //
        delay(100);
      } else if (dataRX == 247) //Letra correspondiente al transmisor 4 boton ok
      {
        valor_md = 7; //
        delay(100);
      }
    ...
    //--------------------------------------------------------------------------------------
    if (250 < dataRX < 260) //Letra correspondiente al transmisor 5
    {
      if (dataRX == 251) //Letra correspondiente al transmisor 5 boton a
      {
        valor_me = 1; //
        delay(100);
      } else if (dataRX == 252) //Letra correspondiente al transmisor 5 boton b
      {
        valor_me = 2; //
        delay(100);
      } else if (dataRX == 253) //Letra correspondiente al transmisor 5 boton c
      {
        valor_me = 3; //
        delay(100);
      } else if (dataRX == 254) //Letra correspondiente al transmisor 5 boton d
      {
        valor_me = 4; //
        delay(100);
      } else if (dataRX == 255) //Letra correspondiente al transmisor 5 boton e
      {
        valor_me = 5; //
        delay(100);
      } else if (dataRX == 256) //Letra correspondiente al transmisor 5 boton f
      {
        valor_me = 6; //
        delay(100);
      } else if (dataRX == 257) //Letra correspondiente al transmisor 5 boton ok
      {
        valor_me = 7; //
        delay(100);
      }
